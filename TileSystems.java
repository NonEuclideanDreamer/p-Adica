...
public class TileSystems 
{
	...
	public static TileSystems sierpinski()
	{
		double[]min= {-2/Math.sqrt(3),-1},max= {1/Math.sqrt(3),1};
		int[]rot= {3},
				mir= {2};
		Rn[] corners= {new Rn(new double[] {-2/Math.sqrt(3),0}), new Rn(new double[] {1/Math.sqrt(3),-1}), new Rn(new double[] {1/Math.sqrt(3),1})};
		return new TileSystems(new Prototile[] {new Prototile(corners)},min,max,mir,rot,4);
	}
	public static TileSystems rectangle()
	{
		double[]min= {-Math.sqrt(3),-1},max= {Math.sqrt(3),1};
		int[]rot= {2},
				mir= {2};
		Rn[]corners= {new Rn(new double[] {-Math.sqrt(3),-1}),new Rn(new double[] {-Math.sqrt(3),1}),new Rn(new double[] {Math.sqrt(3),1}),new Rn(new double[] {-Math.sqrt(3),1})};
		return new TileSystems(new Prototile[] {new Prototile(corners)},min,max,mir,rot,4);
	...
	{	
		int[]rot= {1},
		mir= {1};
	double[] min=new double[] {0,-.125},max =new double[] {4,2.125};//whole visible
			//min={0,0},max= {4.0/3,4.0/3};//
	...
	public static TileSystems halfIsoc()
	{
		double sqrt=Math.sqrt(3),x=sqrt/(16+9*sqrt);
		double[]min= {0,0},max={sqrt,1};
		int[]rot= {1},
		mir=rot;
		Rn[] corners= {new Rn(new double[] {0.000,0.000}), new Rn(new double[] {sqrt,0}), new Rn(new double[] {sqrt,1})};
